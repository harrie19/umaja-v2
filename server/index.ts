 ...
 */
app.get('/api/umaja-core/watcher', async (req: Request, res: Response) => {
  try {
 ...
 */
app.post('/api/umaja-core/watcher', async (req: Request, res: Response) => {
  try {
 ...
 */
app.get('/api/umaja-core/gaianet', async (req: Request, res: Response) => {
  try {
 ...
 */
app.post('/api/umaja-core/gaianet', async (req: Request, res: Response) => {
  try {
    const gaianetSync = guardian.getGaiaNetSync();
 ...
 */
app.get('/api/umaja-core/bio-reminder', async (req: Request, res: Response) => {
  try {
 ...
 */
app.post('/api/umaja-core/bio-reminder', async (req: Request, res: Response) => {
  try {
 ...
 */
app.post('/api/umaja-core/milestone', async (req: Request, res: Response) => {
  try {
 ...
 */
app.get('/api/umaja-core/status', async (req: Request, res: Response) => {
  try {
